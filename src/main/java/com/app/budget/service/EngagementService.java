...
public class EngagementService {
        ...
        public EngagementService(EngagementRepository engagementRepository, ApplicationEventPublisher publisher,
                        BonEngagementNumeroService numeroService, LiquidationRepository liquidationRepository) {
        ...
        public List<EngagementDTO> getAllAttenter(Long projet, Long exercice, Long categorie, OffsetDateTime debut,
                        OffsetDateTime fin, Integer page,
                        Integer size) {
                Pageable pageable = PageRequest.of(page != null ? page : 0, size != null ? size : size.MAX_VALUE);
        ...
        public List<EngagementDTO> getAllReceptionner(Long projet, Long exercice, Long categorie, OffsetDateTime debut,
                        OffsetDateTime fin, Integer page,
                        Integer size) {
                Pageable pageable = PageRequest.of(page != null ? page : 0, size != null ? size : size.MAX_VALUE);
        ...
        public List<EngagementDTO> getAllRetourner(Long projet, Long exercice, Long categorie, OffsetDateTime debut,
                        OffsetDateTime fin, Integer page,
                        Integer size) {
        ...
        public List<EngagementDTO> getAllRejeter(Long projet, Long exercice, Long categorie, OffsetDateTime debut,
                        OffsetDateTime fin, Integer page,
                        Integer size) {
        ...
        public List<EngagementDTO> getAllValider(Long projet, Long exercice, Long categorie, OffsetDateTime debut,
                        OffsetDateTime fin, Integer page,
                        Integer size) {
        ...
        public List<RapportGlobalExecution> rapportGlobalExecution(Long projet, Long exercice, Long categorie) {

                List<RapportGlobalExecution> rapports = new ArrayList<>();
                List<RapportGlobalExecutionInterface> rap = engagementRepository.rapporGeneral(exercice, projet,
                                categorie);
                if (!rap.isEmpty()) {
                        for (RapportGlobalExecutionInterface rapport : rap) {
                                RapportGlobalExecution exe = new RapportGlobalExecution();
                                BigDecimal montantLiquide = liquidationRepository.rapporGeneralLiquidation(exercice,
                                                rapport.getPlanactivite().getId());
                                exe.setPlanActivite(rapport.getPlanactivite());
                                exe.setMontantEngage(rapport.getSomme());
                                exe.setMontantLiquide(montantLiquide);
                                rapports.add(exe);
                        }
                }
                return rapports;
