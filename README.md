...
```
java -Dspring.profiles.active=production -jar ./target/budget-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.app/budget
```
